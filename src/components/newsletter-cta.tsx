  ...
  const copy =
    locale === "fr"
      ? {
          ...
          body: "Un digest clair, axé builders, pour suivre les sorties de modèles, les agents et les patterns qui comptent.",
          bullets: [
          ...
          successBody: "Bienvenue. Vérifiez votre boîte de réception si une confirmation est nécessaire.",
          errorTitle: "Échec de l'inscription",
          error: "Impossible de vous inscrire. Réessayez dans quelques minutes.",
          privacy: "1 email par semaine. Pas de spam. Désinscription en 1 clic.",
